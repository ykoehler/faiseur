...
/// Unique identifier of the user who owns these settings.
 String get userId;/// When these settings were last updated.
 DateTime get updatedAt;/// When these settings were created.
 DateTime get createdAt;/// Theme mode preference: 'light', 'dark', or 'system'.
...
@override
String toString() {
  return 'UserSettings(userId: $userId, updatedAt: $updatedAt, createdAt: $createdAt, themeMode: $themeMode, notificationsEnabled: $notificationsEnabled, emailNotificationsEnabled: $emailNotificationsEnabled, defaultViewMode: $defaultViewMode, showTutorialOnLaunch: $showTutorialOnLaunch, languageCode: $languageCode, darkMode: $darkMode)';
}
...
class _UserSettings extends UserSettings {
  const _UserSettings({required this.userId, required this.updatedAt, required this.createdAt, this.themeMode = 'system', this.notificationsEnabled = true, this.emailNotificationsEnabled = true, this.defaultViewMode = 'list', this.showTutorialOnLaunch = true, this.languageCode = 'en', this.darkMode = false}): super._();
