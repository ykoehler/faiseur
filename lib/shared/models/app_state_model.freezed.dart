...
mixin _$AppState {
  ...
  int get hashCode => Object.hash(
      runtimeType, isInitialized, currentUserId, isLoading, errorMessage);
...
extension AppStatePatterns on AppState {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(bool isInitialized, String? currentUserId, bool isLoading,
            String? errorMessage)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _AppState() when $default != null:
        return $default(_that.isInitialized, _that.currentUserId,
