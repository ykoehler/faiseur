...
extension FailurePatterns on Failure {
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case FirestoreFailure() when firestore != null:
        return firestore(_that.message, _that.code);
      case StorageFailure() when storage != null:
        return storage(_that.message);
      case NotFoundFailure() when notFound != null:
        return notFound(_that.message);
      case StateFailure() when state != null:
        return state(_that.message);
      case CancelledFailure() when cancelled != null:
...
class FirestoreFailure extends Failure {
  ...
  $FirestoreFailureCopyWith<FirestoreFailure> get copyWith =>
      _$FirestoreFailureCopyWithImpl<FirestoreFailure>(this, _$identity);
...
/// @nodoc
abstract mixin class $FirestoreFailureCopyWith<$Res>
    implements $FailureCopyWith<$Res> {
  factory $FirestoreFailureCopyWith(
          FirestoreFailure value, $Res Function(FirestoreFailure) _then) =
      _$FirestoreFailureCopyWithImpl;
  @override
  @useResult
...
class CancelledFailure extends Failure {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $CancelledFailureCopyWith<CancelledFailure> get copyWith =>
      _$CancelledFailureCopyWithImpl<CancelledFailure>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is CancelledFailure &&
            (identical(other.message, message) || other.message == message));
  }
...
/// @nodoc
abstract mixin class $CancelledFailureCopyWith<$Res>
    implements $FailureCopyWith<$Res> {
  factory $CancelledFailureCopyWith(
          CancelledFailure value, $Res Function(CancelledFailure) _then) =
      _$CancelledFailureCopyWithImpl;
  @override
  @useResult
  $Res call({String message});
}
